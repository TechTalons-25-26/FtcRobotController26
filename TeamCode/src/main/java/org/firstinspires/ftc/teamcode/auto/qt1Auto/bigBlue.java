    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path4 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(48.000, 84.000), new Pose(48.000, 60.000))
                    )
                    .setLinearHeadingInterpolation(
                            Math.toRadians(-52),
                            Math.toRadians(-180)
            ...
            Path7 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(48.000, 60.000), new Pose(48.000, 36.000))
                    )
                    .setLinearHeadingInterpolation(
                            Math.toRadians(-64),
                            Math.toRadians(-180)
            ...
            Path9 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(24.000, 36.000), new Pose(48.000, 36.000))
                    )
                    .setLinearHeadingInterpolation(
                            Math.toRadians(-180),
                            Math.toRadians(-70)
